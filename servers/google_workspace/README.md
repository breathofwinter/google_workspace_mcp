...
> **Repository layout note:** This README now lives in `servers/google_workspace/` so all relative paths (Dockerfile, Compose file, manifests, etc.) assume you are running commands from this directory.
